		...
		<div class="col-12">
			<div class="card">
				<div class="modal-header">
					<form class="form-horizontal" method="post"  action="<?php echo site_url('sekcam/Disposisi');?>">
								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url('sekcam/detaildisposisi/'.$key->id_disposisi) ?>" class="btn btn-outline-primary" data-toggle="tooltip" title="Detail Disposisi"><i class="fa fa-search"></i></a>
											<a href="<?php echo base_url('sekcam/del_disposisi/'.$key->id_disposisi) ?>" class="btn btn-outline-danger" data-toggle="tooltip" onclick="return confirm('Hapus Disposisi?')" title="Hapus Disposisi"><i class="fa fa-trash"></i></a>
...
<div class="modal fade text-xs-left" id="update<?php echo $e->id_disposisi ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
	<div class="modal-dialog modal-lg" role="document">
		<div class="modal-content">
			...
			<form method="post" action="<?php echo base_url('sekcam/update_disposisi/'.$e->id_disposisi) ?>" enctype="multipart/form-data">
