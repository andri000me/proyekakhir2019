			...
			<div class="card">
				<div class="card-block">
					...
					<div class="form-group">
						...
						<a href="<?php echo site_url('kasubag/cetak_export/');?><?php echo $this->input->post('dari');?>/<?php echo $this->input->post('sampai');?>" target="_blank" class="btn btn-outline-success"><i class="fa fa-download"></i> Export Excel</a>
					</div>
					<table class="table">
						<tr>
							<td>No</td>
