								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											...
											<a href="<?php echo base_url('kasubag/delkeluar/'.$key->id_skeluar) ?>" class="btn btn-outline-danger" data-toggle="tooltip" onclick="return confirm('Hapus surat keluar?')" title="Hapus Surat keluar"><i class="fa fa-trash"></i></a>
	...
	<div class="modal fade text-xs-left" id="update<?php echo $e->id_skeluar ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel1" aria-hidden="true">
		<div class="modal-dialog modal-lg" role="document">
			<div class="modal-content">
				...
				<form method="post" action="<?php echo base_url('kasubag/updatekeluar/'.$e->id_skeluar) ?>" enctype="multipart/form-data">
