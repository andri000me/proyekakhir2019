...
<div data-scroll-to-active="true" class="main-menu menu-fixed menu-dark menu-accordion menu-shadow">
  ...
  <div class="main-menu-content">
    ...
    <li class=" nav-item"><a href="#"><i class="fa fa-envelope"></i><span data-i18n="nav.advance_cards.main" class="menu-title">Arsip Surat</spanent></a>
      ...
      <li class=" nav-item"><a href="<?php echo base_url('kasubag/disposisi') ?>"><i class="fa fa-envelope-open"></i><span data-i18n="nav.dash.main" class="menu-title">Disposisi Surat</span><span class="tag tag tag-primary tag-pill float-xs-right mr-2"><?php echo $total_disposisi;?></span></a>
      </li>
