							...
							<table cellspacing="0" class="display nowrap table table-hover table-striped table-bordered tableku" width="100%">
								...
								<tbody id="isi">
									...
									<tr>
										...
										<td>
											<a href="<?php echo base_url('camat/detailsuratkeluar/'.$key->id_skeluar) ?>" class="btn btn-outline-primary" data-toggle="tooltip" title="Detail Surat keluar"><i class="fa fa-search"></i></a>
