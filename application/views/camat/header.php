<?php 
$admin = $this->db->where('id_pegawai',$this->session->userdata('camat'))->get('pegawai')->result();
?>
    ...
    <ul id="main-menu-navigation" data-menu="menu-navigation" class="navigation navigation-main">
      <li class=" nav-item"><a href="<?php echo base_url('camat') ?>"><i class="icon-home3"></i><span data-i18n="nav.dash.main" class="menu-title">Dashboard</span></a>
       ...
       <li class=" nav-item"><a href="#"><i class="fa fa-envelope"></i><span data-i18n="nav.advance_cards.main" class="menu-title">Arsip Surat</spanent></a>
        <ul class="menu-cont">
          <li><a href="<?php echo base_url('camat/suratmasuk') ?>" data-i18n="nav.cards.masuk" class="menu-item">Surat Masuk</a>
          </li>
          <li><a href="<?php echo base_url('camat/suratkeluar') ?>" data-i18n="nav.cards.keluar" class="menu-item">Surat Keluar</a>
          </li>
        </ul>
      </li>
      ...
      <li class=" nav-item"><a href="<?php echo base_url('camat/rekapitulasisurat') ?>"><i class="fa fa-file"></i><span data-i18n="nav.dash.main" class="menu-title">Rekapitulasi Surat</span></a>
      </li>
